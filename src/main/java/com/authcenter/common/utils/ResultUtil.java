...
public final class ResultUtil {
     ...
     * @return ResponseEntity 响应实体
     */
    public static ResponseEntity result(HttpStatus status, MessageCodeConstant errorCode, String msg, Object data) {
        HashMap<String, Object> res = new HashMap<>();
        res.put("code", status.value());
        res.put("data", data);
        res.put("msg", msg);
        if (errorCode != null) {
            ...
            msgMap.put("message_en", errorCode.getMsgEn());
            msgMap.put("message_zh", errorCode.getMsgZh());
            res.put("msg", msgMap);
        }
        ResponseEntity<HashMap<String, Object>> responseEntity =

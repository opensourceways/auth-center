...
public class GitcodeSigServiceImpl implements CronjobServiceInter {
    ...
    private void syncSig() {
        LOGGER.info("sync ascend gitcode sig start");
        try {
            ...
            LOGGER.error("parse ascend gitcode sig failed: " + e.getMessage());
        }
        LOGGER.info("sync ascend gitcode sig end");
    }
